...
')
     ...
     */ 
         ...
         *
         * @param \Stancl\Tenancy\Tenant|int|string $tenant
         * @return void 
         * @static 
         */ 
         ...
         * 
         *
         * @return \Stancl\Tenancy\TenancyBootstrapper[] 
         * @static 
         */ 
         ...
         * 
         *
         * @return \Stancl\Tenancy\Tenant|\Stancl\Tenancy\Model 
         * @static 
         */ 
         ...
         *
         * @param \Stancl\Tenancy\Tenant[]|\Traversable|string[]|null $tenants
         * @param callable $callback
         * @return void 
         * @static 
         */ 
